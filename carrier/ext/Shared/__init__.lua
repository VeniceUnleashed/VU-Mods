...
function carrierShared:__init()
	print("Initializing carrierShared")
	self:RegisterVars()
	self:RegisterEvents()
end


function carrierShared:RegisterVars()
	--self.m_this = that
end


function carrierShared:RegisterEvents()
	self.m_PartitionLoadedEvent = Events:Subscribe('Partition:Loaded', self, self.OnPartitionLoaded)
end


function carrierShared:OnPartitionLoaded(p_Partition)
